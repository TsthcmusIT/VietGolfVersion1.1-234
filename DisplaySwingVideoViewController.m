//
//  DisplaySwingVideoViewController.m
//  VietGolfVN
//
...
@interface DisplaySwingVideoViewController ()

@end

@implementation DisplaySwingVideoViewController

@synthesize video;
@synthesize playerSVideo, _MovieURL;
@synthesize _DrawView;
@synthesize audioPlayer, audioRecorder, firstAsset, audioAsset;
@synthesize ActivityView, pullLeftView, currentRow, _IsMaster;
...
- (void)viewDidLoad
{
    ...
    _ScreenName = DisplaySwingVideoScreen;
...
- (void)playVideoWithData:(SVideoInfo*)data{
    ...
    playerSVideo = [AVPlayer playerWithURL:[[NSURL alloc] initFileURLWithPath:data._PathVideo]];
    ...
    if (data._PathVideo != nil) {
        asset = [AVAsset assetWithURL:[[NSURL alloc] initFileURLWithPath:data._PathVideo]];
    } else {
                                            ...
                                            dispatch_async(dispatch_get_main_queue(), ^{
                                                ...
                                                else
                                                {
                                                    ...
                                                    if (_IsMaster) {
                                                        ...
                                                        [_CoreGUI commitSwingVideo:video withType:1];
                                                    }

//
//  DisplaySwingVideoViewController.h
//  VietGolfVN
//
...
@interface DisplaySwingVideoViewController : AbstractViewController<UIImagePickerControllerDelegate, UINavigationControllerDelegate, PullableViewDelegate,UITextFieldDelegate,UIAlertViewDelegate,UIActionSheetDelegate, AVAudioRecorderDelegate, AVAudioPlayerDelegate, MPMediaPickerControllerDelegate, UIGestureRecognizerDelegate>
{
    UIButton *btnBack;
    UIView *viewAddVoice;
    UIButton *btnToolBox;
